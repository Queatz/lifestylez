...
class GoodsControllerTest < ActionController::TestCase
  ...
  test "should create good" do
    assert_difference('Good.count') do
      post :create, good: { description: @good.description, life_style_id: @good.life_style_id, title: @good.title, url: @good.url }
    end
  ...
  test "should update good" do
    patch :update, id: @good, good: { description: @good.description, life_style_id: @good.life_style_id, title: @good.title, url: @good.url }
    assert_redirected_to good_path(assigns(:good))
  end
